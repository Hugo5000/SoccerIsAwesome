...
import static at.iamsoccer.soccerisawesome.itemrename.dialog.AbstractRenameDialog.COMPACT_STYLE;

public class ItemCustomNameRenameDialog2 {
    ...
    private ItemCustomNameRenameDialog2() {
    }

    private static final DialogAction applyAction = DialogAction.customClick(ItemCustomNameRenameDialog2::onApply, UNLIMITED_CALLBACK_OPTIONS);
    private static final DialogAction previewAction = DialogAction.customClick(ItemCustomNameRenameDialog2::onPreview, UNLIMITED_CALLBACK_OPTIONS);
    ...
    private static @NonNull Component parseInput(Player player, String input) {
        return AbstractRenameDialog.serializerFor(player).deserialize(input)
